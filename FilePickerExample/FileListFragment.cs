namespace com.xamarin.recipes.filepicker
{
    ...
    {
        public static readonly string DefaultInitialDirectory = "/" + Android.OS.Environment.ExternalStorageDirectory.AbsolutePath + "/" + Android.OS.Environment.DirectoryDcim;
